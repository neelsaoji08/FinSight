...
def search_for_stock_news_urls(ticker):
    ...
    url = f'https://www.google.com/search?q=moneycontrol+{ticker}'
...
def pipeline_moneycontrol(monitored_tickers):

    raw_urls = {ticker: search_for_stock_news_urls(
        ticker) for ticker in monitored_tickers}
    news_urls = {ticker: get_news_links(
